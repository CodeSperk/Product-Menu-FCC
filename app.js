...
const menuEl = document.querySelector(".items-container");
...
function displayMenuButtons() {
  ...
  // to set dynamic buttons to the container
  btnsContainer.innerHTML = categoryBtns.join("");
  console.log(categoryBtns.join(""));

  const btns = document.querySelectorAll(".btn");
  // to add filter to the buttons
...
function displayMenuItems(menuItems) {
  let singleItem = menuItems.map(function (item) {
